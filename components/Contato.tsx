          ...
          <div>
            ...
            <div className="space-y-6">
              {contatos.map((c, i) => (
                ...
                >
                  <span className="flex-shrink-0 w-12 h-12 flex items-center justify-center border border-primary/15 text-primary group-hover:border-teal group-hover:text-teal transition-colors duration-200">
                    {icons[c.type]}
                  </span>
                  <div>
